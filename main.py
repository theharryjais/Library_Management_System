#Harry Jaiswal,Batch30B,Student_id=210264#
from tkinter import*
...
def Database():
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('Harry', 'admin')")
        conn.commit()
...
#==============================LABELS=========================================
lbl_title = Label(canvas, text = "ADMIN   LOGIN", font=('Papyrus', 30,'bold', ),bg='navy', fg='red')
lbl_title.place(x=500,y=100)
lbl_username = Label(canvas, text = "Username:", font=('Papyrus', 15,'bold'),bd=4,bg='peachpuff4', fg='orange')
lbl_username.place(x=500,y=230)
lbl_password = Label(canvas, text = "Password :", font=('Papyrus', 15,'bold'),bd=3, bg='peachpuff4', fg='orange')
...
#==============================ENTRY WIDGETS==================================#
username = Entry(canvas, textvariable=USERNAME, font=(14), bg='black', fg='cyan',bd=6)
username.place(x=650, y=230,)
password = Entry(canvas, textvariable=PASSWORD, show="*", font=(14),bg='black', fg='cyan',bd=6)
password.place(x=650, y=330)

#==============================BUTTON WIDGETS=================================#
btn_login = Button(canvas, text="LOGIN", font=('Papyrus 15 bold'),width=25,command=Login, bg='lightblue1', fg='red')
